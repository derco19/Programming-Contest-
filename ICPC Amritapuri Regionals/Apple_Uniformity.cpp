...
// index of array should start from 1 and index of segment tree should start from 1
// size of segment vec is 4 times the array vec
// this is to change segment tree functionality
