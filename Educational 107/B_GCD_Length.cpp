...
int main()
{
    ...
    while(t--)
    {
        ll a,b,c;
        cin>>a>>b>>c;
        ll pr[10]={1,11,101,1009,10007,100003,1000003,10000019,100000007,1000000007};
        ll pr1[10]={2,13,103,1013,10037,100019,1000033,10000079,100000037,-1};
        ll pq=a-c;
        ll pqr=b-c;
        pqr=pr1[pqr]*pr[c-1];
        cout<<pr[pq]*pr[c-1]<<" "<<pqr<<"\n";
    }  
}
