...
void solve(int TN){
    ...
    bt.in(root);
    cout<<"\nhienps"<<endl;
    vi an =bt.inorder(root);
    print_vec_int(an);*/
    ll int n;
    cin>>n;
    vector<ll int> ve(n),vp,vn;
    ll int nc=0,pc=0,zc=0,zc2=0;
